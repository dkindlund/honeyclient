...
{
public:
	virtual void OnProcessEvent(BOOLEAN bCreate, wstring processParentPath, wstring processPath, wstring extraData) = 0;
};
...
public:
	...
	*/
	...
	void NotifyListeners(BOOLEAN bCreate, wstring processParentPath, wstring processPath, wstring extraData);
