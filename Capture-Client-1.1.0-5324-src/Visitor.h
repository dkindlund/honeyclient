...
typedef pair <wstring, wstring> Client_Pair;
typedef pair <wstring, wstring> Url_Pair;
...
public:
	...
	*/
	void NotifyListeners(int eventType, wstring url, wstring visitor);
...
protected:
	...
	*/
	stdext::hash_map<wstring, wstring> visitorClientsMap;
};
