...
HoneyClient::Agent::Driver::Browser::IE - Perl extension to fetch the content
of a given web page.  This extends the Browser class by implementing
the getContent() function.

=head1 VERSION

This documentation refers to HoneyClient::Agent::Driver::Browser::IE version 0.9.2.
...
sub drive {
    ...
    # Spawn the job.
    $job->spawn(undef, "\"C:\\Program Files\\Internet Explorer\\iexplore.exe\"" . $args{'url'});
