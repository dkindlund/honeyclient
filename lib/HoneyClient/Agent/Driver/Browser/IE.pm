...
HoneyClient::Agent::Driver::Browser::IE - Perl extension to drive Microsoft
Internet Explorer to a given web page.  This package extends the
HoneyClient::Agent::Driver::Browser package, by overridding the drive() method.

=head1 VERSION

This documentation refers to HoneyClient::Agent::Driver::Browser::IE version 0.98.
...
The following functions have been overridden by the IE driver.  All other
...
I<Output>: The updated IE driver B<$object>, containing state information from driving the
...
Lastly, we assume that the Microsoft Internet Explorer browser has
